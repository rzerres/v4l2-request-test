...
int drm_dmabuf_create(int drm_fd, unsigned int width, unsigned int height, struct video_buffer *buffer)
{
	...
	buffer->destination_offsets[0] = 0;
	buffer->destination_offsets[1] = width * height;

	buffer->destination_bytesperlines[0] = width;
	buffer->destination_bytesperlines[1] = width;
